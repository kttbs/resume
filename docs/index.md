...
| 案件名                       | 契約期間              | 主な業務内容                                                                                                                 |
|---------------------------|-------------------|------------------------------------------------------------------------------------------------------------------------|
| 金融系SaaS型資産運用基盤システム開発案件    | 2025/10 ~         | toBプロダクトのバックエンド開発<br/>toCプロダクトの設計レビュー/バックエンド開発<br/> 社内用管理画面のフロントエンド/バックエンド新規開発<br/>AI Agentにおける開発業務効率化のためのSkillsチューニング | 
| ファッション系計測システム開発案件（DevOps） | 2024/10 ~ 2025/09 | 社内用管理画面のフロントエンド新規開発<br/>計測系システムにおけるバックエンド開発/最適化                                                                        | 
...
- アジャイル、スクラムの推進
- 各 AI Agent 使用時の開発効率化のための Skills チューニング
...
|---------------------------------------------------------------------------------------------------------------|------|---------------------------------|-----------------------------------------|
| <img src="https://img.shields.io/badge/-Scala-DC322F?style=for-the-badge&logo=Scala&logoColor=white" />       | 5 年  | <input type="checkbox" checked> | 最近の業務でメインで使用<br/>・Cats<br/>・Cats Effect |
...
[//]: # (<details open><summary>2025/10 ~ 現在：金融系SaaS型資産運用基盤システム開発  </summary>)

### 2025/10 ~ 現在：金融系SaaS型資産運用基盤システム開発案件

toC, toB 向けプロダクトの機能開発として参画。のちに併せて AI 推進チームにも参画し、AI Agent を用いた開発業務効率化のための Skills 構築、布教も担当。
機能開発においては新規機能の設計レビューおよび実装を担当し、タスクの SP より前倒しで完了するよう努める。
併せて、レガシーコードを現ドメイン構造を含むクリーンアーキテクチャに準拠するように修正するなどのリファクタリングも進める。
この現場の toB プロダクトでは、ドメインマスタと言える立場の設計者が作成した、ほぼ完成形の仕様書に沿って実装を進める流れです。
そのため、Agent Skills を社員の方とペアプロしながら構築し、品質と開発効率の向上に努めた。
toC のプロダクトでは、ドメイン・データモデルの設計レビュー/実装に加え、一部 Ruby on Rails で実装されている管理画面も担当。

- **プロジェクト規模：**
	- 5 ~ 8 人チームでのスクラム開発
- **使用技術：**
	- Scala, Scalike JDBC, Doobie, Thrift, Cats, Ruby on Rails
	- AI Agent
		- Codex (EnterPrise)
		- Claude Code（Bedrock 経由）
- **役割：**
	- 設計レビュー、バックエンド/（フロントエンド）開発、 AI Agent 利用における Skills 構築、布教
- **担当プロジェクト：**
	- toB プロダクトのバックエンド開発
		- 仕様書に準拠した実装、および仕様不備に対するフィードバック
		- レガシーコード（弱い DDD）を、現ドメイン構造に準拠するように修正するなどのリファクタリング
	- toC プロダクトの設計レビュー/バックエンド開発
		- ドメインおよびデータモデルの設計レビュー/実装
		- Ruby で構築されている管理画面の実装
	- その他
		- AI Agent を用いた開発業務効率化のための Skills 構築、布教
			- Codex および ClaudeCode を用いた、コード生成のためのプロンプトエンジニアリングの試行錯誤、生成されたコードに対するチームへのフィードバック

[//]: # (</details>)

[//]: # (<details open><summary>2024/10 ~ 現在 ファッション系計測システム開発案件  </summary>)

### 2024/10 ~ 2025/09 ファッション系計測システム開発案件
...
- AI Agent を用いた開発業務効率化のための Skills/Hooks の設定を含むチューニングに興味があります
